...
firmware_baremetal.mk

  Called by firmware.mk to build CMSIS/SPL baremetal based firmware.
...
baremetal.mk
  ...
  Called by ../Makefile to set BAREMETAL specific parameters if 
  PX4_TARGET_OS is set to "baremetal".
